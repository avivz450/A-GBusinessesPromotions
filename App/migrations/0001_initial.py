# Generated by Django 3.2.5 on 2021-07-18 13:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('business', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='business', to='App.business')),
                ...
                ('sale', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sale', to='App.sale')),
