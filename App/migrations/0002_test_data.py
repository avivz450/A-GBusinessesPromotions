...
class Migration(migrations.Migration):
    ...
    def generate_data(apps, schema_editor):
        ...
        with transaction.atomic():
            ...
            user1 = User.objects.create_superuser(username='Aviv', password='AvivAviv', email='Aviv@gmail.com').save()
            user2 = User.objects.create_superuser(username='Gideon',
                                                  password='GideonGideon', email='Gideon@gmail.com').save()
